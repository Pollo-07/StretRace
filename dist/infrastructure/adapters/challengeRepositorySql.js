...
class challengeRepositorySql {
    ...
    async getMyChallengeExists(id_retado, id_retador) {
        try {
            const pool = await connection_1.default.getConnection();
            const result = await pool
                .request()
    ...
    async acceptChallenge(id, id_retado) {
        try {
            const pool = await connection_1.default.getConnection();
            await pool
                .request()
    ...
    async rejectChallenge(id, id_retado) {
        try {
            const pool = await connection_1.default.getConnection();
            await pool
                .request()
    ...
    async completeChallenge(id, ganador_id) {
        try {
            const pool = await connection_1.default.getConnection();
            await pool
                .request()
    ...
    async reporteChallenge(id, id_ganador, userId, notas) {
        try {
            const pool = await connection_1.default.getConnection();
            await pool
                .request()
